...
$string['viewblindgradesforuser'] = 'View blind grades for {$a}';
$string['manageuserblindgrades'] = 'Manage blind grades submitted by {$a}';
$string['managemyblindgrades'] = 'Manage my blind grades';
$string['maxvarianceforautograde'] = 'Maximum variance for autograding (%)';
$string['requiredvsubmitted'] = '{$a->submitted} of {$a->required} grades submitted';
$string['blindgrade'] = 'Blind grade';
$string['outsidevariancerequiresreview'] = 'Blind grades outside variance, requires review';
...
$string['avgblindmarking:managegraders'] = 'Manage graders';
